...
async function parseExcelFile(event, filePath) {
...
const register$1 = (ipcMain2) => {
  ipcMain2.handle("parseExcelFile", parseExcelFile);
};
...
const register = (ipcMain2) => {
  ...
  ipcMain2.handle("selectExcel", selectExcel);
};
...
const ipcModules = {};
const modules = /* @__PURE__ */ Object.assign({ "./modules/auth.ts": __vite_glob_0_0, "./modules/excel.ts": __vite_glob_0_1, "./modules/file.ts": __vite_glob_0_2 });
